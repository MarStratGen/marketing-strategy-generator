  ...
  return (
    <div>
      ...
      <div className="max-w-4xl mx-auto mt-20 mb-12 px-6">
        <div className="bg-gray-900/95 backdrop-blur-lg border border-gray-600 rounded-2xl p-8 shadow-2xl">
      ...
      {/* Footer Disclaimer */}
      <footer className="bg-gray-900/90 backdrop-blur-lg border-t border-gray-600 py-12 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gray-800/80 rounded-xl p-8 border border-gray-600">
            <h3 className="text-xl font-bold text-white mb-4 text-center">Important Disclaimer</h3>
            ...
            <p className="text-gray-300 text-sm text-center border-t border-gray-600 pt-4">
