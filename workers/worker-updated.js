  ...
  "channel_playbook": [
    {
      ...
      "summary": "Detailed strategic explanation of this channel's role and approach. Include specific tactics, target audience, and strategic importance. This should be 2-3 comprehensive sentences that provide actionable insights.",
      ...
      "budget_percent": 45,
      "why_it_works": "Detailed strategic rationale explaining why this channel is effective for this specific business model, market, and target audience. Include competitive advantages and market dynamics."
    },
    {
      "channel": "Secondary Channel Name", 
      "intent": "High|Mid|Low",
      "role": "Channel function",
      "summary": "Detailed strategic explanation for this channel's role and implementation approach. Include specific tactics, timing, and integration with other channels. 2-3 comprehensive sentences.",
      "key_actions": ["Specific tactical action 1", "Specific tactical action 2", "Specific tactical action 3"],
      "success_metric": "Primary success measurement for this channel with specific details",
      "budget_percent": 30,
      "why_it_works": "Detailed strategic rationale for why this channel delivers results in this context, including market positioning and customer behaviour insights."
    },
    {
      "channel": "Tertiary Channel Name",
      "intent": "High|Mid|Low", 
      "role": "Channel function",
      "summary": "Detailed strategic explanation for this supporting channel. Include specific implementation details, audience targeting, and strategic value. 2-3 comprehensive sentences.",
      "key_actions": ["Specific tactical action 1", "Specific tactical action 2"],
      "success_metric": "Primary success measurement for this channel with specific details", 
      "budget_percent": 25,
      "why_it_works": "Detailed strategic rationale explaining the unique value this channel provides and how it complements the overall channel strategy."
    }
  ],
