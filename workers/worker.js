  ...
  async fetch(req, env) {
    ...
    try {
      ...
      const aiResponse = await fetch("https://api.openai.com/v1/chat/completions", {
        ...
        body: JSON.stringify({
          ...
          messages: [
            ...
            { 
              role: "user", 
              content: `Generate marketing strategy for ${form.product_type} in ${form.country} ${form.sector}. Target: ${audienceText}. Competitors: ${competitorText}. Write in plain text only - NO markdown, asterisks, dashes, or special formatting. JSON with: market_foundation (market overview, customer behaviour, competitor analysis featuring ${competitorText}, opportunities), strategy_pillars (3 pillars with names and strategies), personas (Primary Persona: [name and detailed description], Secondary Persona: [name and detailed description], Tertiary Persona: [name and detailed description]), competitors_brief (analysis of ${competitorText}), differentiators (core differentiation, value proposition, positioning), seven_ps (product, price, place, promotion, people, process, physical evidence strategies), calendar_next_90_days (Week 1-2 foundation, Week 3-4 launch, Week 5-8 scaling, Week 9-12 optimisation with specific weekly activities), kpis (specific channel metrics like cost per acquisition and conversion rates, business KPIs like revenue growth and customer lifetime value, measurement tools and reporting framework), risks_and_safety_nets (primary risks, mitigation strategies, contingency plans).` 
            }
          ]
        }),
      ...
      let json = {
        ...
        personas: aiGenerated?.personas || "Primary Persona: The Quality Seeker\nAge 35-50, household income £40,000+, values quality over price. Researches thoroughly before purchasing, reads reviews, and prioritises established brands. Shops online and in-store, influenced by recommendations from trusted sources.\n\nSecondary Persona: The Budget-Conscious Family\nAge 25-40, household income £25,000-40,000, price-sensitive but quality-aware. Compares prices across multiple retailers, uses discount codes, and makes planned purchases. Active on social media for deals and recommendations.\n\nTertiary Persona: The Convenience Shopper\nAge 30-55, busy lifestyle, values convenience and time-saving. Willing to pay premium for fast delivery and easy returns. Shops via mobile apps, uses subscription services, and influenced by targeted advertising.",
        ...
        kpis: aiGenerated?.kpis || "Channel KPIs\nSearch advertising: Conversion rate 3-5%, click-through rate 2-4%, quality score above 7/10.\nSocial media: Click-through rate 1.5-3%, engagement rate 2-4%, video completion rate above 75%.\nEmail marketing: Open rate 20-25%, click rate 3-6%, unsubscribe rate below 2%.\nInfluencer partnerships: Engagement rate 3-8%, click-through rate 2-5%, brand mention sentiment above 80%.\n\nBusiness KPIs\nMonthly revenue growth 8-15%, repeat purchase rate 25-35%, customer retention rate above 75%, average order value growth 5-10%, net promoter score 50+, website conversion rate 2-4%.\n\nMeasurement Framework\nGoogle Analytics 4 for website tracking, Facebook Pixel for social media attribution, email platform analytics for campaign performance, CRM system for customer journey tracking, monthly performance reviews with stakeholder reporting.",
