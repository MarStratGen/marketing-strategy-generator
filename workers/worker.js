  ...
  async fetch(req, env) {
    ...
    try {
      ...
      let json = {
        ...
        kpis: aiGenerated?.kpis || "Channel KPIs\nSearch advertising: Cost per click £0.50-1.20, conversion rate 3-5%, cost per acquisition £25-45.\nSocial media: Click-through rate 1.5-3%, engagement rate 2-4%, cost per acquisition £30-60.\nEmail marketing: Open rate 20-25%, click rate 3-6%, revenue per email £0.15-0.40.\nInfluencer partnerships: Engagement rate 3-8%, click-through rate 2-5%, cost per acquisition £20-50.\n\nBusiness KPIs\nMonthly revenue growth 8-15%, customer acquisition cost £35-65, customer lifetime value £180-320, average order value £45-85, repeat purchase rate 25-35%, net promoter score 50+.\n\nMeasurement Framework\nGoogle Analytics 4 for website tracking, Facebook Pixel for social media attribution, email platform analytics for campaign performance, CRM system for customer journey tracking, monthly performance reviews with stakeholder reporting.",
