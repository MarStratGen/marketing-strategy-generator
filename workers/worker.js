...

{
  ...
  "kpis": "Generate contextual Key Performance Indicators that align with the specific business type, sector, and marketing channels being recommended. For digital marketing strategies, include relevant metrics like conversion rates, cost per acquisition, and click-through rates. For traditional marketing strategies, focus on brand awareness, market penetration, foot traffic, referral rates, and customer surveys. For B2B businesses, emphasise lead quality, pipeline progression, customer lifetime value, and sales cycle metrics. For retail/restaurant businesses, track foot traffic, average transaction value, repeat customer rates, and local market share. For agricultural/seasonal businesses, focus on sales volume per season, dealer network growth, and customer retention rates. Include appropriate measurement tools and data sources that match the recommended marketing channels - Google Analytics for digital, customer surveys for traditional, CRM systems for B2B, sales data for retail. DO NOT use generic digital marketing KPIs that don't apply to traditional marketing channels or specific business contexts.",
