  ...
  async fetch(req, env) {
    ...
    try {
      ...
      const aiResponse = await fetch("https://api.openai.com/v1/chat/completions", {
        ...
        body: JSON.stringify({
          ...
          messages: [
            { 
              role: "system", 
              content: "Expert marketing strategist. British English only. Write dense, specific content. NO markdown, asterisks, dashes or bullet points. Use plain text with clear headings. Include named competitors prominently." 
            },
            { 
              role: "user", 
              content: `Generate marketing strategy for ${form.product_type} in ${form.country} ${form.sector}. Target: ${audienceText}. Competitors: ${competitorText}. Use clear formatting with proper headings and structure. JSON with: market_foundation (Market Overview section, Customer Behaviour section, Competitor Analysis section featuring ${competitorText}, Market Opportunities section), strategy_pillars (Pillar 1: [clear name] then strategy description, Pillar 2: [clear name] then strategy description, Pillar 3: [clear name] then strategy description), personas (Primary Persona: [name] then Age, income, behaviour, motivations, shopping habits. Secondary Persona: [name] then demographics and behaviour. Tertiary Persona: [name] then demographics and behaviour), competitors_brief (detailed analysis of ${competitorText}), differentiators (Core Differentiation section, Value Proposition section, Positioning Statement section), seven_ps (Product section, Price section, Place section, Promotion section, People section, Process section, Physical Evidence section), calendar_next_90_days (Week 1-2: Foundation Phase then specific activities, Week 3-4: Launch Phase then specific activities, Week 5-8: Scaling Phase then specific activities, Week 9-12: Optimisation Phase then specific activities), kpis (Channel KPIs section with specific metrics and targets, Business KPIs section with growth targets, Measurement Framework section with tools), risks_and_safety_nets (Primary Risks section, Mitigation Strategies section, Contingency Plans section).` 
            }
          ]
        }),
      ...
      let json = {
        ...
        strategy_pillars: aiGenerated?.strategy_pillars || "Pillar 1: Customer Excellence\nDevelop deep customer understanding and deliver exceptional experiences that exceed expectations whilst building long-term loyalty and advocacy through personalised service and continuous improvement.\n\nPillar 2: Market Leadership\nEstablish thought leadership and competitive advantage through innovation, quality excellence, and strategic positioning in key market segments whilst differentiating from competitors.\n\nPillar 3: Operational Efficiency\nOptimise operational processes and systems to deliver consistent quality, reduce costs, and enable scalable growth whilst maintaining service excellence and profitability.",
        personas: aiGenerated?.personas || "Primary Persona: The Quality Seeker\nAge 35-50, household income above average, values quality over price. Research-driven purchaser who reads reviews extensively and prioritises established brands with proven track records. Shops both online and in-store, heavily influenced by recommendations from trusted sources and expert opinions.\n\nSecondary Persona: The Budget-Conscious Family\nAge 25-40, moderate household income, price-sensitive but quality-aware. Compares prices across multiple retailers, actively seeks discount codes and special offers, makes planned purchases rather than impulse buying. Active on social media for deals and recommendations from other families.\n\nTertiary Persona: The Convenience Shopper\nAge 30-55, busy professional lifestyle, values convenience and time-saving above cost considerations. Willing to pay premium for fast delivery, easy returns, and seamless shopping experience. Prefers mobile apps, subscription services, and one-click purchasing options.",
        ...
        calendar_next_90_days: aiGenerated?.calendar_next_90_days || "Week 1-2: Foundation Phase\nEstablish core marketing infrastructure including analytics setup, create brand assets and messaging frameworks, set up tracking systems across all channels, and launch primary campaign initiatives with baseline measurement frameworks in place.\n\nWeek 3-4: Launch Phase\nExecute main marketing campaigns across priority channels, implement customer acquisition activities, begin content creation and distribution, start performance monitoring and initial optimisation based on early data signals.\n\nWeek 5-8: Scaling Phase\nExpand successful initiatives based on performance data, optimise underperforming channels, introduce secondary marketing tactics, scale winning campaigns for broader reach, and implement advanced targeting and personalisation strategies.\n\nWeek 9-12: Optimisation Phase\nRefine strategies based on comprehensive performance data, implement advanced tactics and automation, prepare strategic initiatives for next quarter, document learnings and best practices for future campaigns.",
        kpis: aiGenerated?.kpis || "Channel KPIs\nSearch advertising: Conversion rate 3-5%, click-through rate 2-4%, quality score above 7/10, cost per acquisition trending downward monthly.\nSocial media: Click-through rate 1.5-3%, engagement rate 2-4%, video completion rate above 75%, follower growth rate 5-10% monthly.\nEmail marketing: Open rate 20-25%, click rate 3-6%, unsubscribe rate below 2%, list growth rate 8-12% monthly.\nInfluencer partnerships: Engagement rate 3-8%, click-through rate 2-5%, brand mention sentiment above 80%, reach amplification 3x minimum.\n\nBusiness KPIs\nMonthly revenue growth 8-15%, repeat purchase rate 25-35%, customer retention rate above 75%, average order value growth 5-10% quarterly, net promoter score 50+, website conversion rate 2-4%, customer lifetime value increasing 10% yearly.\n\nMeasurement Framework\nGoogle Analytics 4 for comprehensive website tracking and conversion attribution, Facebook Pixel for social media campaign attribution, email platform analytics for detailed campaign performance, CRM system for complete customer journey tracking, monthly performance reviews with stakeholder reporting and quarterly strategy adjustments.",
